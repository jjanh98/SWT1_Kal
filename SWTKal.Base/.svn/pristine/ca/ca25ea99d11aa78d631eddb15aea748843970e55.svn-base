...
public class TermineIFTest extends TestCase
{
	...
	protected void setUp() throws Exception
	{
		...
		t = new Termin(p, "Testtermin", "Dies ist der Langtext zum Testtermin", d, d.addDauer(1), SimpleServer.getUniqueRunningID());
		t2 = new Termin(p2, "Testtermin", "Dies ist der Langtext zum Testtermin", d, d.addDauer(25), SimpleServer.getUniqueRunningID());
		t3 = new Termin(p, "Testtermin", "Dies ist der Langtext zum Testtermin", d.addDauer(600), d.addDauer(625), SimpleServer.getUniqueRunningID());
		t4 = new Termin(p, "Testtermin", "Dies ist der Langtext zum Testtermin", d.addDauer(600), d.addDauer(626), SimpleServer.getUniqueRunningID());
		t5 = new Termin(p, "Testtermin", "Dies ist der Langtext zum Testtermin", d.addDauer(700), d.addDauer(701), SimpleServer.getUniqueRunningID());
	...
	public void testInsert() throws Exception
	{
		...
		Termin neuTermin = new Termin(t.getBesitzer(),
                                      ...
                                      t.getLangText(),
					                  t.getBeginn(),
					                  t.getEnde(), SimpleServer.getUniqueRunningID());
		...
		Termin termin = new Termin(person, "Kurztext", "Langtext", d, d.addDauer(1), SimpleServer.getUniqueRunningID());
	...
	public void testDelete() throws Exception
	{
		...
		Termin termin = new Termin(p, "Neukurz", "Neulang", d, d.addDauer(1), SimpleServer.getUniqueRunningID());
	...
	public void testGetTermineVonBis() throws Exception
	{
		...
		zwischen.add(10);
		Termin zwTermin = new Termin(p, "Neukurz", "Neulang", zwischen, zwischen.addDauer(1), SimpleServer.getUniqueRunningID());
		...
		nach2.add(1);
		Termin nachTermin = new Termin(p, "Neukurz", "Neulang", nach1, nach2, SimpleServer.getUniqueRunningID());
